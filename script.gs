var SS = SpreadsheetApp.openById('191WEvUPhvU3hv4QvDrgUDvR7Lk8Lc7Nvrv1w3F89uw0');
...
function doPost(e) {
  ...
  if (parsedData !== undefined){
    ...
    var value3 = dataArr [3]; // value0 from Arduino code - Fathers Name
    var value4 = dataArr [4]; // value1 from Arduino code - Phone 
